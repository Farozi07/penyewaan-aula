...
<body class="loading" data-layout-color="light" data-layout-mode="default" data-layout-size="fluid"
    ...
    <div id="wrapper">
        ...
        <div class="navbar-custom bg-light">
            ...
            <!-- LOGO -->
            <div class="logo-box bg-light">
                <a href="index.html" class="logo logo-light text-center">
                    <span class="logo-sm">
                        <img src="{{ asset('/') }}/assets/images/logo-bpsdm.png" alt="" height="50">
                    </span>
                    <span class="logo-lg">
                        <img src="{{ asset('/') }}/assets/images/logo-bpsdm.png" alt="" height="60">
                    </span>
                </a>
            ...
            <ul class="list-unstyled topnav-menu topnav-menu-left mb-0">
                <li>
                    <button class="button-menu-mobile disable-btn waves-effect ms-3">
                        <i class="fe-menu"></i>
                    </button>
                </li>
